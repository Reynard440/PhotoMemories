    ...
    deletePhoto = (photoId, photoLink) => {
        ...
        setTimeout(() => {
            if (this.props.deletedPhotoObj.error === '') {
                ...
                if (this.props.deletedPhotoObj.error !== '') {
                    this.setState({"deleteListError" : true, "method":"post"});
                    setTimeout(() => this.setState({"deleteListError": false}), 4000);
                }
            }
        }, 1500);
    };
        ...
        return (
            <div>
                <div className={"listMain"}>
                    <div style={{"display": this.state.deleteListError ? "block": "none"}}>
                        <PhotoPadToast show={this.state.deleteListError} message={"Access Required, please consult with the owner."} type={"ad"}/>
                    </div>
